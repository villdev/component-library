  ...
  return (
    <div className="component-wrapper container-md">
      ...
      <div className="badge-wrapper mr-4">
        ...
        <span className="badge bg-blue">9</span>
      </div>
      <div className="badge-wrapper">
        ...
        <span className="badge bg-blue">10+</span>
      </div>
      ...
      <div className="badge-wrapper mr-4">
        ...
        <span className="badge badge--md bg-blue">2</span>
      </div>
      <div className="badge-wrapper">
        <svg
      ...
      <div className="badge-wrapper mr-4">
        ...
        <span className="badge-dot badge-dot--sm bg-blue"></span>
      </div>
      <div className="badge-wrapper mr-4">
        <svg
          className="icon-md fill-white"
        ...
        <span className="badge-dot bg-blue"></span>
      </div>
      <div className="badge-wrapper">
        <svg
          className="icon-lg fill-white"
        ...
        <span className="badge-dot badge-dot--lg bg-blue"></span>
      </div>
      {/* -------------------badge alignment---------------- */}
      ...
      <div className="badge-wrapper mr-4">
        ...
        <span className="badge badge--sm badge--bottom bg-blue">1</span>
      </div>
      <div className="badge-wrapper mr-4">
        <svg
          className="icon-md fill-white"
        ...
        <span className="badge badge--md badge--bottom bg-blue">2</span>
      </div>
      <div className="badge-wrapper">
        <svg
          className="icon-lg fill-white"
        ...
        <span className="badge badge--lg badge--bottom bg-blue">3</span>
      </div>
      {/* -------------------badge avatar---------------- */}
