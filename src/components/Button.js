...
export default function Button() {
  return (
    <div className="component-wrapper container-md">
      ...
      <button className="btn btn--sm text-white bg-blue-500 mr-4">
        Submit
      </button>
      <button className="btn text-white bg-black mr-4">Submit</button>
      <button className="btn btn--lg mr-4">Search</button>
      {/* ----------------border radius roudned pill -------------------*/}
      <h3>Primary buttons with border radius variants</h3>
      <button className="btn btn--sm text-white bg-blue-500 mr-4">
        Submit
      </button>
      <button className="btn btn--sm btn--rounded text-white bg-black mr-4">
        Submit
      </button>
      <button className="btn btn--sm btn--pill mr-4">Search</button>
      ...
      <button className="btn btn--sm btn--rounded btn--no-shadow btn--blue mr-4">
        Submit
      </button>
      <button className="btn btn--sm btn--rounded btn--no-shadow btn--dark mr-4">
        Submit
      </button>
      <button className="btn btn--sm btn--rounded btn--no-shadow btn--default mr-4">
        Search
      </button>
      {/* ----------------outlined----------------------------- */}
      ...
      <button className="btn btn--sm btn--rounded btn--danger mr-4">
        <div className="btn__icon icon-sm">
          <svg focusable="false" viewBox="0 0 24 24" aria-hidden="true">
      ...
      <button className="btn btn--sm btn--rounded btn--yellow mr-4">
        <div className="btn__icon icon-sm">
          <svg focusable="false" viewBox="0 0 24 24" aria-hidden="true">
            <path d="M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12zM19 4h-3.5l-1-1h-5l-1 1H5v2h14V4z"></path>
          </svg>
      ...
      <button className="btn btn--sm btn--rounded btn--outlined btn--success mr-4">
        <div className="btn__icon icon-sm">
          <svg focusable="false" viewBox="0 0 24 24" aria-hidden="true">
      ...
      {/* ----------------disabled btns -------------------*/}
      <h3>Disabled btns</h3>
      <button className="btn btn--rounded btn--sm btn--blue btn--disabled mr-4">
        Submit
      </button>
      ...
      <h3>Using text-button utility</h3>
      <button className="btn btn--rounded btn--sm btn--danger text-button  mr-4">
        Submit
      </button>
      <button className="btn btn--rounded btn--sm btn--success text-button  mr-4">
        Search
      </button>
      <button className="btn btn--rounded btn--sm btn--blue text-button mr-4">
        Search
      </button>
      <button className="btn btn--rounded btn--sm btn--yellow text-button mr-4">
        Search
      </button>
      <button className="btn btn--sm btn--rounded btn--outlined btn--danger text-white text-button mr-4">
        Search
      </button>
      <button className="btn btn--sm btn--rounded btn--outlined btn--success text-white text-button mr-4">
        Submit
      </button>
      <button className="btn btn--sm btn--rounded btn--outlined btn--blue text-white text-button mr-4">
        Search
      </button>
      <button className="btn btn--sm btn--rounded btn--outlined btn--yellow text-white text-button mr-4">
        Search
      </button>
    </div>
  );
